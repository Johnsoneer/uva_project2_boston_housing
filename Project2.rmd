...
We identify the high leverage observations, which are the data points that are the most influential. We ran leverages analysis, Cook's distance, and DFFITs to find the most influential data point. The outlive observation 368 was repeatedly included as an influential observation, however, Cook's distance resulted in no values. Though observation 368 is of concern, the analysis indicates that there is only one true outlier. 
...
### Benchmark Model Summary 
```{r,message= FALSE, echo=FALSE,  out.width="75%", out.height="50%", fig.align = 'center'}
